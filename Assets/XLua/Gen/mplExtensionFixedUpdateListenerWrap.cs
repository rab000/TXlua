...
namespace XLua.CSObjectWrap
{
    ...
    public class mplExtensionFixedUpdateListenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(mplExtension.FixedUpdateListener);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					mplExtension.FixedUpdateListener gen_ret = new mplExtension.FixedUpdateListener();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to mplExtension.FixedUpdateListener constructor!");
        ...
        static int _m_Get_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _listenerTag = LuaAPI.lua_tostring(L, 2);
                        ...
                        mplExtension.FixedUpdateListener gen_ret = mplExtension.FixedUpdateListener.Get( _go, _listenerTag );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.GameObject>(L, 1)) 
                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        mplExtension.FixedUpdateListener gen_ret = mplExtension.FixedUpdateListener.Get( _go );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Component>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _listenerTag = LuaAPI.lua_tostring(L, 2);
                        ...
                        mplExtension.FixedUpdateListener gen_ret = mplExtension.FixedUpdateListener.Get( _comp, _listenerTag );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Component>(L, 1)) 
                {
                    UnityEngine.Component _comp = (UnityEngine.Component)translator.GetObject(L, 1, typeof(UnityEngine.Component));
                        ...
                        mplExtension.FixedUpdateListener gen_ret = mplExtension.FixedUpdateListener.Get( _comp );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to mplExtension.FixedUpdateListener.Get!");
        ...
        static int _m_Dispose(RealStatePtr L)
        {
		    try {
                ...
                mplExtension.FixedUpdateListener gen_to_be_invoked = (mplExtension.FixedUpdateListener)translator.FastGetCSObj(L, 1);
