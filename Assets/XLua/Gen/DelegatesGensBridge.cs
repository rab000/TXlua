...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(UnityEngine.GameObject p0, string p1, bool p2)
		{
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp7(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UIDemo.FDelegate(__Gen_Delegate_Imp0);
			}
			...
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new UnityEngine.AudioSettings.AudioConfigurationChangeHandler(__Gen_Delegate_Imp14);
			}
