...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGUIElementWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.GUIElement);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.GUIElement gen_ret = new UnityEngine.GUIElement();
        ...
        static int _m_HitTest(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.GUIElement gen_to_be_invoked = (UnityEngine.GUIElement)translator.FastGetCSObj(L, 1);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _screenPosition;translator.Get(L, 2, out _screenPosition);
                        ...
                        bool gen_ret = gen_to_be_invoked.HitTest( _screenPosition );
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Camera>(L, 3)) 
                {
                    ...
                    UnityEngine.Camera _camera = (UnityEngine.Camera)translator.GetObject(L, 3, typeof(UnityEngine.Camera));
                        ...
                        bool gen_ret = gen_to_be_invoked.HitTest( _screenPosition, _camera );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_GetScreenRect(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        UnityEngine.Rect gen_ret = gen_to_be_invoked.GetScreenRect(  );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Camera>(L, 2)) 
                {
                    UnityEngine.Camera _camera = (UnityEngine.Camera)translator.GetObject(L, 2, typeof(UnityEngine.Camera));
                        ...
                        UnityEngine.Rect gen_ret = gen_to_be_invoked.GetScreenRect( _camera );
                        translator.Push(L, gen_ret);
