...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePropertyAttributeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.PropertyAttribute);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.PropertyAttribute does not have a constructor!");
        }
        ...
        static int _g_get_order(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.PropertyAttribute gen_to_be_invoked = (UnityEngine.PropertyAttribute)translator.FastGetCSObj(L, 1);
