...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit8(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(TestLuaUI), TestLuaUIWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(TestLuaUIDemo), TestLuaUIDemoWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(NXLua.TLuaMgr), NXLuaTLuaMgrWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(NTHotfix.CSharpMono4Hotfix), NTHotfixCSharpMono4HotfixWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(mplExtension.ApplicationListener), mplExtensionApplicationListenerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(mplExtension.EnabledListener), mplExtensionEnabledListenerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(mplExtension.FixedUpdateListener), mplExtensionFixedUpdateListenerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(mplExtension.GUIListener), mplExtensionGUIListenerWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(mplExtension.Injection), mplExtensionInjectionWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(mplExtension.LuaBehaviour), mplExtensionLuaBehaviourWrap.__Register);
