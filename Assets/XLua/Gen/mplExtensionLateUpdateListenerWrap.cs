...
namespace XLua.CSObjectWrap
{
    ...
    public class mplExtensionLateUpdateListenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(mplExtension.LateUpdateListener);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					mplExtension.LateUpdateListener gen_ret = new mplExtension.LateUpdateListener();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to mplExtension.LateUpdateListener constructor!");
        ...
        static int _m_Get_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _listenerTag = LuaAPI.lua_tostring(L, 2);
                        ...
                        mplExtension.LateUpdateListener gen_ret = mplExtension.LateUpdateListener.Get( _go, _listenerTag );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.GameObject>(L, 1)) 
                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        mplExtension.LateUpdateListener gen_ret = mplExtension.LateUpdateListener.Get( _go );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Component>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _listenerTag = LuaAPI.lua_tostring(L, 2);
                        ...
                        mplExtension.LateUpdateListener gen_ret = mplExtension.LateUpdateListener.Get( _comp, _listenerTag );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Component>(L, 1)) 
                {
                    UnityEngine.Component _comp = (UnityEngine.Component)translator.GetObject(L, 1, typeof(UnityEngine.Component));
                        ...
                        mplExtension.LateUpdateListener gen_ret = mplExtension.LateUpdateListener.Get( _comp );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to mplExtension.LateUpdateListener.Get!");
        ...
        static int _m_Dispose(RealStatePtr L)
        {
		    try {
                ...
                mplExtension.LateUpdateListener gen_to_be_invoked = (mplExtension.LateUpdateListener)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_lateUpdate(RealStatePtr L)
        {
		    try {
                ...
                mplExtension.LateUpdateListener gen_to_be_invoked = (mplExtension.LateUpdateListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.lateUpdate = translator.GetDelegate<System.Action<XLua.LuaTable>>(L, 2);
